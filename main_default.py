...
class MyNewNet(nn.Module):
  def __init__(self):
    ...
    self.linear_layers = nn.Linear(num_fltrs, 10)
...
#optimizer=AdaBelief(net.parameters(), lr=0.0005, eps =1e-8, betas=(0.9, 0.999),
#                    weight_decay = 5e-4, weight_decouple=False, rectify=False,
#                    fixed_decay=False)

scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max=50, last_epoch=-1)
